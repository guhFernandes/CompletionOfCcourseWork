<!-- Inicio Cards Moved -->
<div id="desktop" class="carousel bg-body-tertiary p-4 slide mt-3" data-bs-ride="carousel">

<h1 class="display-6 mb-4 text-navy text-center">Categorias</h1>
...
<div class="carousel-inner">
        ...
        <div class=" d-flex  justify-content-evenly container-sm">
            ...
            <div class="card h-100 overflow-hidden rounded-4 shadow-lg" style="width: 18rem;">
                ...
                <div class="d-flex flex-column h-100 p-3 pb-0 text-shadow-1">
                    <ul class=" list-unstyled mt-auto">
                        <li class="text-center">
                            <a class="btn-navy fs-5" href="{{url('test/Calça')}}" role="button">Calça</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class=" d-flex  justify-content-evenly container-sm">
            ...
            <div class="card h-100 overflow-hidden rounded-4 shadow-lg" style="width: 18rem;">
                ...
                <div class="d-flex flex-column h-100 p-3 pb-0 text-shadow-1">
                    <ul class=" list-unstyled mt-auto">
                        <li class="text-center">
                            <a class="btn-navy fs-5" href="{{url('test/Macação')}}" role="button">Macacão</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <button class="carousel-control-prev" type="button" data-bs-target="#desktop"
        data-bs-slide="prev">
        <span class="carousel-control-prev-icon bg-navy p-4 rounded-4 " aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#desktop"
        data-bs-slide="next">
