...
@section('title', 'High Fashion | Dicas de Modas')
@section('content')
    <x-site.navbar />
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mt-3">
                <h3 class="text-navy">1. Esqueça que os básicos são só o preto e o branco</h3>
                <img src="{{asset('storage/imagem/dica/truques-de-moda-1.jpg')}}" class="card-img" alt="truques-de-moda-1">
                <p class="fs-4 text-navy">
            ...
            <div class="col-12 mt-3">
                <h3 class="text-navy">2. Brinque com diferentes tecidos e suas texturas</h3>
            ...
            <div class="col-12 mt-3">
                <h3 class="text-navy">3. A terceira peça pode fazer milagres</h3>
            ...
            <div class="col-12 mt-3">
                <h3 class="text-navy">4. Feminilidade nem sempre tem a ver com “mulherzinha”</h3>
            ...
            <div class="col-12 mt-2">
                <h3 class="text-navy">5. Os acessórios dizem muito sobre quem você é</h3>
