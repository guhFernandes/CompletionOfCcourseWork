...
<body>
  <article class="markdown-body"><h2 class="atx" id="manual-do-usuarioadministrador---high-fashion™">Manual do Usuário/Administrador - HIGH FASHION™</h2>
<blockquote>
<h4 class="atx" id="sumario">Sumário</h4>
<blockquote>
<ul>
<li><p>Introdução</p>
</li>
...
<li><p>Primeiro Acesso </p>
</li>
<li><p>Como Adicionar Usuário</p>
</li>
<li><p>Como Listar/ Editar/ Excluir Usuário</p>
</li>
<li><p>Como Adicionar Caregoria </p>
</li>
<li><p>Como Editar/Excluir Categoria</p>
</li>
<li><p>Como Adicionar Coleção </p>
</li>
<li><p>Como Editar/Excluir Coleção</p>
</li>
<li><p>Como Adicionar Produto </p>
</li>
<li><p>Como Editar/Excluir Produto</p>
</li>
<li><p>Termos de Uso</p>
</li>
<li><p>Versão do Sistema </p>
</li>
</ul>
</blockquote>
</blockquote>
<h3 class="atx" id="introducao">Introdução</h3>
<p>Está página define as características, propriedades e ações do website da High Fashion Confecções, responsável pela produção das peças expostas no site.</p>
<h3 class="atx" id="sistema">Sistema</h3>
<p>Fica estabelecido que o sistema, tem como finalidade exibir um catálogo digital das coleções criadas pela High Fashion. Tem um gerenciamento de banco de dados, onde o administrador, cadastra produtos, coleções, tipos de roupas e usuários.</p>
<h3 class="atx" id="primeiro-acesso">Primeiro Acesso</h3>
<p><img alt="" src="{{ asset('storage/imagem/help/login_adm.png') }}"></p>
<h3 class="atx" id="como-adicionar-usuario">Como Adicionar Usuário</h3>
<p><img alt="" src="{{ asset('storage/imagem/help/ls_add_usuario.png') }}"></p>
<h3 class="atx" id="como-listar-editar-excluir-usuario">Como Listar/ Editar/ Excluir Usuário</h3>
<p><img alt="" src="{{ asset('storage/imagem/help/ls_usuario.png') }}"></p>
<h3 class="atx" id="como-adicionar-categoria">Como Adicionar Categoria</h3>
<img width="781" alt="" src="{{ asset('storage/imagem/help/add_categoria.png') }}" title="">





<h3 class="atx" id="como-editarexcluir-categoria">Como Editar/Excluir Categoria</h3>
<p><img alt="" src="{{ asset('storage/imagem/help/ls_categoria.png') }}"></p>
<h3 class="atx" id="como-adicionar-colecao">Como Adicionar Coleção</h3>
<p><img alt="" src="{{ asset('storage/imagem/help/add_colecao.png') }}"></p>
<h3 class="atx" id="como-editarexcluir-colecao">Como Editar/Excluir Coleção</h3>
<p><img alt="" src="{{ asset('storage/imagem/help/ls_colecao.png') }}"></p>
<h3 class="atx" id="como-adicionar-produto">Como Adicionar Produto</h3>
<img width="781" alt="" src="{{ asset('storage/imagem/help/add_produto.png') }}" title="">
...
<h3 class="atx" id="como-editarexcluir-produto">Como Editar/Excluir Produto</h3>
<p><img alt="" src="{{ asset('storage/imagem/help/ed_produto.png') }}"> </p>
<h3 class="atx" id="termo-de-uso">Termo de Uso</h3>
<p>O usuário é o único e exclusivo respolsável por qualquer tipo de inclusão,edição e exclusão no sistema. </p>
<p>Consciderando que mediante qualquer modificação nos dados sera realizado o registro de autenticação do usuário responsavel pela modificação. </p>
<p>Em virtude disso o usuário é responsável por tudo, que se refere a conteúdo, tais como textos, imagens e a propría identidade. </p>
<h3 class="atx" id="versao-do-sistema">Versão do Sistema:</h3>
<p>High Fashion Confecções Ltda (Versão: 1.0)</p>
</article>
</body>
</html>